import { CommonPagingResponse } from '../../core/entities';
import { GoodsModel } from '../models/goods.model';

export interface MockGoodsList extends CommonPagingResponse<GoodsModel> {}

export const mockGoodsList: GoodsModel[] = [
  // https://static.msscdn.net/musinsaUI/homework/data/goods0.json
  {
    ...
    price: 59000,
    brandName: '에프씨엠엠',
    // imageUrl 1759350_2_400가 404여서 1759350_5_500로 변경
    imageUrl:
      'https://image.msscdn.net/images/goods_img/20210122/1759350/1759350_5_500.jpg',
  ...
  },
  {
    ...
    brandName: '예일',
    imageUrl:
      'https://image.msscdn.net/images/goods_img/20200928/1628383/1628383_3_500.jpg',
  ...
  // https://static.msscdn.net/musinsaUI/homework/data/goods2.json
  {
    goodsNo: 1778031,
    ...
    imageUrl:
      // 404: 1778031_4_500 => 1778031_5_500
      'https://image.msscdn.net/images/goods_img/20210204/1778031/1778031_5_500.jpg',
  ...
  // https://static.msscdn.net/musinsaUI/homework/data/goods3.json
  {
    goodsNo: 2209409,
    goodsName:
