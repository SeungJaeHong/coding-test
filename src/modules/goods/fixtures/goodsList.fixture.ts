...
import { CommonListResponse } from '../../core/entities';

export type MockGoodsList = CommonListResponse<GoodsModel>;

export const mockGoodsList: MockGoodsList = {
  data: {
    list: [
      // https://static.msscdn.net/musinsaUI/homework/data/goods0.json
      {
        ...
        price: 59000,
        brandName: '에프씨엠엠',
        // imageUrl 1759350_2_500가 404여서 1759350_5_500로 변경
        imageUrl:
