 ...
 */
export const acceptApplicationJson = (headers: StringRecord) => {
 ...
 * @param headers 헤더 데이터
 */
export const contentTypeFormData = (headers: StringRecord) => {
 ...
 * @param headers 헤더 데이터
 */
export const contentTypeMultipartFormData = (headers: StringRecord) => {
 ...
 * @param headers 헤더 데이터
 */
export const authorizationBearerToken = (
